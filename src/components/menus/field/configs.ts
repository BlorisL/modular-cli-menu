...
class MenuFieldConfigs {
    ...
    public getIdle(): MenuFieldConfigs['idle'] | undefined { return this.idle; }
    public setIdle(idle: Exclude<MenuFieldConfigIdle | MenuFieldConfigsJson['idle'], undefined>): this {
    ...
    public getHover(): MenuFieldConfigs['hover'] | undefined { return this.hover; }
    public setHover(hover: Exclude<MenuFieldConfigHover | MenuFieldConfigsJson['hover'], undefined>): this {
    ...
    public setSelectable(selectable: boolean): this { this.selectable = selectable; return this; }
