...
class StyleHover {
    ...
    public getPrefix(): StyleHover['prefix'] { return this.prefix; }
    public setPrefix(prefix: StyleHover['prefix']): this {
        if (prefix && prefix.length > 0) this.prefix = prefix;
        return this;
    }

    public getColor(): StyleHover['color'] | undefined { return this.color; }
    public setColor(color: StyleHover['color']): this { this.color = color; return this; }

    public isUnderline(): StyleHover['underline'] | undefined { return this.underline; }
    public setUnderline(underline: StyleHover['underline']): this {
        this.underline = underline;
        return this;
    }

    public isItalic(): StyleHover['italic'] | undefined { return this.italic; }
