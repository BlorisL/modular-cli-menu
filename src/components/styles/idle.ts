...
class StyleIdle {
    ...
    public getPrefix(): StyleIdle['prefix'] { return this.prefix; }
    public setPrefix(prefix: StyleIdle['prefix']): this {
        if (prefix && prefix.length > 0) this.prefix = prefix;
        return this;
    }

    public getColor(): StyleIdle['color'] | undefined { return this.color; }
    public setColor(color: StyleIdle['color']): this { this.color = color; return this; }

    public isUnderline(): StyleIdle['underline'] | undefined { return this.underline; }
    public setUnderline(underline: StyleIdle['underline']): this {
        this.underline = underline;
        return this;
    }

    public isItalic(): StyleIdle['italic'] | undefined { return this.italic; }
